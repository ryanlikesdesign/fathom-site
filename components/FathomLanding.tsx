      ...
      <section className="scrolly" id="features" aria-label="Features">
        ...
        <div className="scrolly-steps">
          ...
          <div className="step" data-step="assistant-plan">
            ...
            <p className="step-body">Fathom thinks for a moment, then shows its work: a short ordered list of steps, each labelled with the mode that will handle it &mdash; Go, Snapshot, Task.</p>
          ...
          <div className="step" data-step="go">
            ...
            <p className="step-body">Directions use a clock-face system: &ldquo;door at 2 o&apos;clock, about eight metres.&rdquo; Obstacle alerts pulse faster as you approach, so the space has a shape you can feel in your hand.</p>
