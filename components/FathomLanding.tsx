      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <p className="hero-lede">
            Fathom is an AI companion for blind and low-vision people. It sees
            what&apos;s ahead, guides you where you&apos;re going, and helps you do what
            you came there to do &mdash; all from your iPhone. No maps, no beacons,
            no setup.
          </p>
        ...
        <div className="problem-inner">
          ...
          <div className="problem-body">
            ...
            <p className="reveal accent">
              Fathom isn&apos;t just a navigation app. It&apos;s a full sensory companion:
              it walks you in, walks you through, and helps with the task at the
              end. Anywhere. First time in.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="scrolly" id="features" aria-label="Features">
            ...
            <div className="phone-screen">
              ...
              <div className="screen screen-assistant" data-screen="assistant">
                ...
                <div className="as-composer">
                  <div className="as-chips">
                    <button className="as-chip"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><path d="M4 6h12M4 12h12M4 18h12"/></svg>Activities</button>
                    <button className="as-chip as-chip-filled"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="10" y="3" width="4" height="11" rx="2"/><path d="M6 11a6 6 0 0 0 12 0"/><path d="M12 17v3"/></svg>Ask Fathom</button>
                  </div>
              ...
              <div className="screen screen-assistant screen-assistant-activities" data-screen="assistant-activities">
                ...
                <div className="as-composer as-composer-menu">
                  ...
                  <div className="as-chips">
                    <button className="as-chip as-chip-highlight"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><path d="M4 6h12M4 12h12M4 18h12"/></svg>Activities</button>
                    <button className="as-chip as-chip-filled"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="10" y="3" width="4" height="11" rx="2"/><path d="M6 11a6 6 0 0 0 12 0"/><path d="M12 17v3"/></svg>Ask Fathom</button>
                  </div>
                  <div className="as-input">Describe your goal&hellip;</div>
                </div>
              ...
              <div className="screen screen-assistant screen-assistant-ask" data-screen="assistant-ask">
                ...
                <div className="screen-pad as-pad">
                  ...
                  <div className="as-transcript" aria-live="polite">
                ...
                <div className="as-composer">
                  <div className="as-chips">
                    <button className="as-chip"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><path d="M4 6h12M4 12h12M4 18h12"/></svg>Activities</button>
                    <button className="as-chip as-chip-filled as-chip-highlight"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="10" y="3" width="4" height="11" rx="2"/><path d="M6 11a6 6 0 0 0 12 0"/><path d="M12 17v3"/></svg>Ask Fathom</button>
                  </div>
                  <div className="as-input">Describe your goal&hellip;</div>
                </div>
              ...
              <div className="screen screen-assistant screen-assistant-plan" data-screen="assistant-plan">
                ...
                <div className="as-sheet" role="dialog" aria-label="Your plan">
                  ...
                  <div className="as-plan-actions">
                    <button className="as-plan-accept">Accept Plan</button>
                    <div className="as-plan-row">
                      <button className="as-plan-alt">Edit</button>
                      <button className="as-plan-alt">Dismiss</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="screen screen-assistant screen-assistant-active" data-screen="assistant-active">
                ...
                <div className="screen-pad as-active-pad">
                  <div className="as-active-bar">
                    <button className="as-active-end"><span className="as-active-x">&times;</span> End</button>
                    ...
                    <button className="as-active-done">&check; Done</button>
                  </div>
                  ...
                  <div className="as-step-card">
                    ...
                    <div className="as-step-footer">
                      ...
                      <button className="as-step-complete">Mark<br/>Complete</button>
                    </div>
                ...
                <div className="as-active-footer">
                  <button className="as-active-ask">
                  ...
                  <button className="as-active-plus">+</button>
                </div>
              </div>
              ...
              <div className="screen screen-lookout" data-screen="lookout">
                ...
                <div className="screen-pad">
                  <div className="lk-nav">
                    <button className="lk-back"><span className="chev-left">&lsaquo;</span> Home</button>
                    <span className="pill-ai"><span className="pill-ai-dot" />AI Enabled</span>
                  </div>
                  <p className="lk-eyebrow">LOOKOUT</p>
                  <div className="seg-pill" aria-hidden="true">
                    <span className="seg">Hazards</span>
                    <span className="seg seg-active">Balanced</span>
                ...
                <div className="lk-actions">
                  <button className="lk-action lk-action-ghost">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="10" y="3" width="4" height="11" rx="2"/><path d="M6 11a6 6 0 0 0 12 0"/><path d="M12 17v3"/></svg>
                    <span><span className="la-title">Ask or Command</span><span className="la-sub">Tap to speak. Say &ldquo;take me to&hellip;&rdquo; to navigate.</span></span>
                  </button>
                  <button className="lk-action lk-action-filled">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 3 4 14h7l-1 7 9-11h-7z" fill="currentColor"/></svg>
                    <span><span className="la-title">Quick Scan</span><span className="la-sub">Fast snapshot of surroundings</span></span>
                  </button>
                </div>
              </div>
              ...
              <div className="screen screen-go" data-screen="go">
                ...
                <div className="go-actions">
                  <button className="go-action go-action-ghost">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="10" y="3" width="4" height="11" rx="2"/><path d="M6 11a6 6 0 0 0 12 0"/><path d="M12 17v3"/></svg>
                    Ask a Question
                  </button>
                  <button className="go-action go-action-filled">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 3 4 14h7l-1 7 9-11h-7z" fill="currentColor"/></svg>
                    Quick Scan
                  </button>
                  <button className="go-action go-action-ghost">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M6 6l12 12M6 18 18 6"/></svg>
                    End Navigation
                  </button>
                </div>
              </div>
              ...
              <div className="screen screen-live" data-screen="live">
                ...
                <div className="live-actions">
                  ...
                  <p className="live-hint">Auto-listens after questions &middot; Tap to speak &middot; Double-tap to repeat</p>
                </div>
              </div>
        ...
        <div className="scrolly-steps">
          ...
          <div className="step" data-step="assistant">
            <MobilePhone><div className="screen screen-assistant" style={{opacity:1,transform:'none'}}><IosStatus time="7:03"/><div className="screen-pad as-pad"><p className="as-eyebrow">NEW SESSION</p><h3 className="as-title">What can I help with?</h3><p className="as-sub">Tell me what you&apos;d like to do and I&apos;ll figure out the best way to help.</p><div className="as-crab" aria-hidden="true"><VoiceOrbIdle className="as-voice-orb"/></div><div className="as-divider"><span>RECENT</span></div><p className="as-none">No sessions yet</p></div><div className="as-composer"><div className="as-chips"><button className="as-chip"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><path d="M4 6h12M4 12h12M4 18h12"/></svg>Activities</button><button className="as-chip as-chip-filled"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="10" y="3" width="4" height="11" rx="2"/><path d="M6 11a6 6 0 0 0 12 0"/><path d="M12 17v3"/></svg>Ask Fathom</button></div><div className="as-input">Describe your goal&hellip;</div></div><TabBar active="assistant"/></div></MobilePhone>
          ...
          <div className="step" data-step="lookout">
            <MobilePhone><div className="screen screen-lookout" style={{opacity:1,transform:'none'}}><IosStatus/><div className="screen-pad"><div className="lk-nav"><button className="lk-back"><span className="chev-left">&lsaquo;</span> Home</button><span className="pill-ai"><span className="pill-ai-dot"/>AI Enabled</span></div><p className="lk-eyebrow">LOOKOUT</p><div className="seg-pill"><span className="seg">Hazards</span><span className="seg seg-active">Balanced</span><span className="seg">Full</span></div><div className="lk-stage"><VoiceOrbListen className="lk-voice-orb"/><p className="lk-listening">Listening...</p></div></div><div className="lk-actions"><button className="lk-action lk-action-ghost"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="10" y="3" width="4" height="11" rx="2"/><path d="M6 11a6 6 0 0 0 12 0"/><path d="M12 17v3"/></svg><span><span className="la-title">Ask or Command</span></span></button><button className="lk-action lk-action-filled"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M13 3 4 14h7l-1 7 9-11h-7z" fill="currentColor"/></svg><span><span className="la-title">Quick Scan</span></span></button></div></div></MobilePhone>
            ...
            <p className="step-body">Three modes &mdash; Hazards, Balanced, Full &mdash; let you dial how much you want to hear. Haptic alerts fire in under 100 ms when something&apos;s close, so the space has a shape you can feel.</p>
            <p className="step-whisper">On-device object detection at 10 fps. Works without a network.</p>
          </div>
          <div className="step" data-step="go">
            <MobilePhone><div className="screen screen-go" style={{opacity:1,transform:'none'}}><IosStatus/><div className="screen-pad"><div className="go-topbar"><span className="pill-ai"><span className="pill-ai-dot"/>AI Enabled</span><span className="link-navy">Go</span></div><h3 className="go-dest">Kitchen</h3><p className="go-sub">Shake when you&apos;ve arrived</p><div className="seg-pill"><span className="seg">Hazards</span><span className="seg seg-active">Balanced</span><span className="seg">Full</span></div><div className="go-center"><VoiceOrbListen className="go-voice-orb"/><p className="go-heading">Heading to Kitchen&hellip;</p></div></div><div className="go-actions"><button className="go-action go-action-ghost"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="10" y="3" width="4" height="11" rx="2"/><path d="M6 11a6 6 0 0 0 12 0"/><path d="M12 17v3"/></svg>Ask a Question</button><button className="go-action go-action-filled"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M13 3 4 14h7l-1 7 9-11h-7z" fill="currentColor"/></svg>Quick Scan</button></div></div></MobilePhone>
            ...
            <p className="step-body">Directions use a clock-face system: &ldquo;door at 2 o&apos;clock, about 10 steps ahead.&rdquo; Obstacle alerts pulse faster as you approach, so the space has a shape you can feel in your hand.</p>
          ...
          <div className="step" data-step="live">
            ...
            <p className="step-whisper">Bidirectional audio and video. Fathom watches and listens at once.</p>
          </div>
        </div>
      </section>
        ...
        <div className="spectrum-inner">
          ...
          <div className="spectrum-grid">
            ...
            <article className="spec-card reveal">
              ...
              <h3>Spatial audio</h3>
              <p>Sound tells you where things are. Left, right, ahead, behind &mdash; no narration needed.</p>
            </article>
            <article className="spec-card reveal">
