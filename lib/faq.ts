...
export const FAQ: FaqItem[] = [
  ...
  { q: "Is my camera data private?", a: "Camera frames are used to generate guidance in the moment. We don't store them, and we don't sell them. The Privacy Policy has the full picture." },
