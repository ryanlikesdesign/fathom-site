...
export const FAQ: FaqItem[] = [
  ...
  { q: "What do I need to use it?", a: "A recent iPhone — that's it. Fathom runs on the camera and sensors already in the phone, with no beacons, no building setup, and nothing to install. On iPhone Pro models, LiDAR adds depth-based hazard detection." },
